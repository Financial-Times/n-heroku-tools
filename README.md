...
For patches to NBT 5 please make PRs to the ‘nbt-five’ branch and release from there.
  ...
  Commands:
    ...
    bottle [options] [increment]                        DEPRECATED.  See: https://github.com/Financial-Times/n-bottle.  Releases a major, minor, patch or prerelease of a next component (similar to npm version + npm publish)
