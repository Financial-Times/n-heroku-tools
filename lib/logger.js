...
const SHIP_IN_BOTTLE = readFileSync(__dirname + '/ship-in-bottle.ascii');
const YACHT = readFileSync(__dirname + '/yacht.ascii');
const CANOE = readFileSync(__dirname + '/canoe.ascii');
const BOTTLE = readFileSync(__dirname + '/bottle.ascii');
